      ...
      <div className="fixed shadow-inner max-w-md pin-b pin-x align-top m-auto justify-end p-8 bg-white w-full flex flex-col relative justify-center rounded h-auto shadow">
        ...
        <form id="signup-form" onSubmit={props.signUpHandler} className="w-full max-w-md">
          ...
          <div className="flex flex-wrap -mx-3 mb-6">
            ...
            <div className='w-full px-3 mb-6 md:mb-0'>
              <input type="submit" value="Sign up" className="select-none inline-block border border-transparent border-teal leading-tight px-4 py-2 rounded no-underline text-teal hover:bg-teal focus:bg-teal hover:text-white focus:text-white focus:shadow-outline">
              </input>
            </div>
          </div>
        </form>
